...
const AssignClientToManager = () => {
    ...
    const fetchManager = async () => {
      ...
      try {
        const response = await axios.post(
          "https://sand-pbmk.onrender.com/api/v1/admin/fetchUsersByRole",
          { role: "manager" }
        );
  ...
  const AssignClientToManager = async (managerId) => {
    try {
      const response = await axios.post(
        "https://sand-pbmk.onrender.com/api/v1/admin/assignClientToManager",
        { clientId, managerId }
      );
  ...
  const unAssignClientToManager = async (managerId) => {
    try {
      const response = await axios.post(
        "https://sand-pbmk.onrender.com/api/v1/admin/unassignClientToManager",
        { clientId, managerId }
      );
