  ...
  const fetchPromoters = async () => {
    try {
      const response = await axios.get(
        "https://sand-6.onrender.com/api/v1/promoter/fetchPromoters"
      );
...
//handled back button issue
  ...
  const assignFormToPromoter = async (promoterId) => {
    try {
      const response = await axios.post(
        "https://sand-6.onrender.com/api/v1/admin/assignCreatedForms",
        {
          formId,
          promoterId,
        }
  ...
  const unassignFormFromPromoter = async (promoterId) => {
    try {
      const response = await axios.post(
        "https://sand-6.onrender.com/api/v1/admin/unassignCreatedForms",
        {
          formId,
          promoterId,
        }
  ...
  const handleCreatePromoter = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://sand-6.onrender.com/api/v1/promoter/registerNewPromoter",
        {
          promoterName,
          promoterEmailId,
          password,
