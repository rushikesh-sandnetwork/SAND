...
const AdminProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        const response = await fetch("https://sand-dymk.onrender.com/api/v1/user/userDetails", {
          method: "POST",
  ...
  const changePassword = async (currentPassword, newPassword) => {
    try {
      const response = await fetch("https://sand-dymk.onrender.com/api/v1/user/changePassword", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
